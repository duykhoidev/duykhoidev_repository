...
const {data, headers} = await os.postRequest("<OAUTH\_AUTHENTICATION\_URL>", params,{headers: {'content-type': 'application/x-www-form-urlencoded'}});  
const token = 'Bearer' + data.access\_token;  
